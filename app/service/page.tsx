      ...
      <section className="relative overflow-hidden border-b border-gray-800 bg-surface-1 py-20">
        ...
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-400">
            Artist management, talent development, entertainment, creative
            media, and specialized ventures — plus premium wellness products.
          </p>
        </div>
      </section>
          ...
          <div className="space-y-12">
            {services.map((service) => {
              ...
              return (
                <div
                  key={service.id}
                  className="glass-card group overflow-hidden p-8 transition-all hover:border-brand-500/40 lg:p-12"
                >
                  <div className="grid items-start gap-8 lg:grid-cols-12">
                    {/* Left Icon & Heading */}
                    <div className="lg:col-span-4">
                      <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-brand-500/10 text-brand-400 ring-1 ring-brand-500/20 transition-colors group-hover:bg-brand-500/20">
                    ...
                    <div className="space-y-6 lg:col-span-8 lg:border-l lg:border-gray-800/80 lg:pl-10">
                      ...
                      {service.details && service.details.length > 0 && (
                        <div className="border-t border-gray-800/60 pt-6">
                          <h3 className="text-label-sm mb-3 text-brand-400">
      ...
      <section className="border-t border-gray-800 bg-surface-1 py-16">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-3 max-w-xl text-gray-400">
            Reach out about services, products, or partnerships — Keith Hopkins
