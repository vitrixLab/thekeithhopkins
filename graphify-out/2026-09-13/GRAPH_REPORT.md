...
## Knowledge Gaps
- **93 isolated node(s):** `siteConfig`, `inter`, `metadata`, `siteConfig`, `services` (+88 more)
...
- **What connects `siteConfig`, `inter`, `metadata` to the rest of the system?**
